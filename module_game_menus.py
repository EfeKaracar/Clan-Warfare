    ...
    [
        ...
        [
            ...
            (try_begin),
                ...
                (troop_raise_attribute, "trp_player", ca_strength, ":bonus"),
                (troop_raise_attribute, "trp_player", ca_agility, ":bonus"),
                (troop_raise_skill, "trp_player", "skl_power_strike", ":bonus"),
                (troop_raise_skill, "trp_player", "skl_athletics", ":bonus"),
                (val_mul, ":bonus", 5),
                (troop_raise_proficiency, "trp_player", wpt_two_handed_weapon, ":bonus"),
                (val_mul, ":bonus", 1000),
...
# #         (change_screen_return),
       # ]),
        ...
        ("map",[],"Start your adventure!",
        [
        (party_relocate_near_party, "p_main_party", "$g_starting_town", 2),
        (spawn_around_party, "p_main_party", "pt_deserters"),
        (assign, ":daemon", reg0),
        (party_clear, ":daemon"),
        (party_set_name, ":daemon", "@Daemon"),
        (party_add_members, ":daemon", "trp_daemonClone", 1),
      ...
      ("tournament_join_next_fight", [], "Fight in the next round.",
       [
           ...
           (try_begin),
             ...
             (try_begin),
               (eq, ":mod", 0),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_armor_red", "itm_tourney_helm_red"),
             (else_try),
               (eq, ":mod", 1),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_armor_red", "itm_tourney_helm_red"),
             (else_try),
           ...
           (else_try),
             ...
             (try_begin),
               (eq, ":mod", 0),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_armor_red", "itm_steppe_helmet_red"),
             (else_try),
               (eq, ":mod", 1),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_armor_red", "itm_steppe_helmet_red"),
             (else_try),
           ...
           (else_try),
             ...
             (try_begin),
               (eq, ":mod", 0),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_tunic_red", "itm_steppe_helmet_red"),
             (else_try),
               (eq, ":mod", 1),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_tunic_red", "itm_steppe_helmet_red"),
             (try_end),
           ...
           (else_try),
             ...
             (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_tunic_red", "itm_arena_helmet_red"),
           (else_try),
             #Sarranids
             (store_mod, ":mod", ":town_index_within_faction", 2),
             (try_begin),
               (eq, ":mod", 0),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_tunic_red", "itm_arena_turban_red"),
             (else_try),
               (call_script, "script_set_items_for_tournament", 0, 0, 50, 80, 0, 0, 0, 0, "itm_arena_tunic_red", "itm_arena_turban_red"),
             (try_end),
           (try_end),
