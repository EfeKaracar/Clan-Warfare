...
##        (gt, ":total_wage", 0),
  ...
  ("coop_assign_drop_to_group_member", prsntf_manual_end_only, 0, [
    ...
    # borrowed from PWmod
  # display player name above the heads of nearby agents
    ...
    (ti_on_presentation_run,
     [
      ...
      (try_begin),
        ...
        (assign, ":overlay_id", 0),
        (agent_get_team, ":my_team", ":my_player"),
        (try_for_agents, ":agent_id"),
          ...
          (le, ":sq_distance", ":agent_sq_distance"),
          ...
          (is_between, ":x_pos", -100, 2200), # check if inside the view boundaries or nearly so
          (is_between, ":y_pos", -100, 1600),
          ...
          (try_begin),
            ...
            (val_mul, ":height", 9), # was 10
            (val_min, ":height", 1200), # was 2000
...
######################################################################################
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (try_begin),
          (eq, ":eek:bject", "$g_presentation_obj_1"), # show towns
          (try_for_range, ":slot_no", 0, "$temp"),
          ...
          (try_end),
        (else_try),
          (eq, ":eek:bject", "$g_presentation_obj_2"), # show castles
          (try_for_range, ":slot_no", 0, "$temp"),
          ...
          (try_end),
        (else_try),
          (eq, ":eek:bject", "$g_presentation_obj_3"), # show villages
          (try_for_range, ":slot_no", 0, "$temp"),
