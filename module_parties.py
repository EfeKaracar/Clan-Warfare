...
###############################################################  
  ...
  #Efe
  ("town_12","Avalon", icon_town|pf_town, no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-1.2, 108.9),[], 25),
...
##  ("black_khergit_spawn_point"  ,"black_khergit_sp",pf_disabled|pf_is_static, no_menu, pt_none, fac_outlaws,0,ai_bhvr_hold,0,(47.1, -73.3),[(trp_looter,15,0)]),
 ...
 # add extra towns before this point 
  ...
  #Efe
    ("invasion_spawn_1_ne","{!}collective_ally",pf_disabled, 
    no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(131,115),[]),
    ("invasion_spawn_2_e","{!}collective_ally",pf_disabled, 
    no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(173,-12),[]),
    ("invasion_spawn_3_nw","{!}collective_ally",pf_disabled, 
    no_menu, pt_none, fac_neutral,0,ai_bhvr_hold,0,(-125,109),[]),
    ("invasion_spawn_4_s","{!}collective_ally",pf_disabled, 
