...
(24, 0, 0, [(store_current_day, ":cur_day"),
       ...
       (try_end),
        ...
        (try_for_range, ":amount", 0, ":max_raider_amount"),
            ...
            (assign, ":bks", reg0),
            (party_clear, ":bks"),
            (store_random_in_range, ":add2", 10, 20),
            (party_add_members, ":bks", "trp_black_shield_infantry", ":add2"),
            (party_add_members, ":bks", "trp_black_shield_follower", ":add2"),
            (party_add_members, ":bks", "trp_black_shield_rider", ":add2"),
        ...
        (try_begin),
            ...
            (try_for_range, ":bks_lords", "trp_bks_1", "trp_bks_12"),
                ...
                (party_add_members, ":bks_party", "trp_black_shield_infantry", ":add"),
                (party_add_members, ":bks_party", "trp_black_shield_follower", ":add"),
                (party_add_members, ":bks_party", "trp_black_shield_rider", ":add"),
            (try_end),
        (try_end),
