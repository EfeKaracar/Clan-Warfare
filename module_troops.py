...
#peasant - retainer - footman - man-at-arms -  knight
  ...
  ["swadian_man_at_arms","Emperor's Hand","Emperor's Hands",tf_mounted|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_helmet|tf_guarantee_horse|tf_guarantee_shield,0,0,fac_kingdom_1,
   ...
   def_attrib|level(24),wp_melee(180),knows_common|knows_riding_4|knows_ironflesh_5|knows_shield_5|knows_power_strike_5,swadian_face_young_1, swadian_face_old_2],
...
# Vaegir watchman?
  ...
  ["vaegir_footman","Novice Shieldwaller","Novice Shieldwallers",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield,0,0,fac_kingdom_2,
   [itm_hand_axe,itm_sword_viking_1,itm_tab_shield_kite_a,itm_tab_shield_kite_b,itm_spear,itm_vaegir_fur_cap,itm_nordic_archer_helmet,itm_rawhide_coat,itm_nomad_armor,itm_nomad_boots],
  ...
  ["vaegir_skirmisher","Veteran Shieldwaller","Veteran Shieldwallers",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield,0,0,fac_kingdom_2,
   [itm_one_handed_war_axe_b,itm_military_cleaver_b,itm_javelin,itm_javelin,itm_leather_jerkin,itm_khergit_guard_helmet,itm_nordic_footman_helmet,itm_nordic_fighter_helmet,itm_leather_vest,itm_tab_shield_round_c,itm_nomad_armor,itm_nomad_boots],
  ...
  ["vaegir_archer","Wyvern Shieldwaller","Wyvern Shieldwallers",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_shield|tf_guarantee_armor,0,0,fac_kingdom_2,
   [itm_military_cleaver_c,itm_sword_khergit_3, itm_jarid, itm_jarid, itm_tab_shield_round_d,
    itm_lamellar_vest,itm_splinted_greaves,itm_vaegir_spiked_helmet,itm_nordic_helmet],
   str_15 | agi_9 | int_4 | cha_4|level(19),wp_one_handed (150) | wp_two_handed (70) | wp_polearm (70) | wp_archery (110) | wp_crossbow (70) | wp_throwing (150),knows_ironflesh_3|knows_power_strike_4|knows_athletics_3|knows_athletics_2|knows_shield_3|knows_power_throw_4,vaegir_face_young_1, vaegir_face_older_2], 
  ["vaegir_marksman","Man of Coifs","Men of Coifs",tf_guarantee_ranged|tf_guarantee_boots|tf_guarantee_shield|tf_guarantee_armor|tf_guarantee_helmet,0,0,fac_kingdom_2,
   [itm_tab_shield_round_e, itm_military_cleaver_b, itm_one_handed_war_axe_b, itm_throwing_spears, itm_throwing_spears,
   itm_banded_armor, itm_mail_coif, itm_mail_chausses],
   str_21 | agi_15 | int_4 | cha_4|level(26),wp_one_handed (200) | wp_two_handed (80) | wp_polearm (80) | wp_archery (140) | wp_crossbow (80) | wp_throwing (200),knows_ironflesh_7|knows_power_draw_5|knows_athletics_6|knows_shield_5|knows_power_throw_4|knows_power_strike_7,vaegir_face_young_1, vaegir_face_older_2], #edited HB down to THIS LINE, everything below still unedited.


  ["vaegir_veteran","Sixth Man","Sixth Men",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield,0,0,fac_kingdom_2,
 ...
 ["abu_inf","Abullell Infantry","Abullell Infantries",tf_guarantee_boots|tf_guarantee_armor,0,0,fac_kingdom_3,
  ...
  ["nord_footman","Pubstomper","Pubstompers",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield,0,0,fac_kingdom_4,
   [itm_fighting_axe,itm_one_handed_war_axe_a,itm_spear,itm_tab_shield_round_a,itm_tab_shield_round_b,itm_javelin,itm_throwing_axes,
    itm_leather_cap,itm_skullcap,itm_nomad_vest,itm_leather_boots,itm_nomad_boots],
   def_attrib|level(10),wp(70),knows_ironflesh_2|knows_power_strike_2|knows_power_throw_2|knows_riding_2|knows_athletics_2|knows_shield_1,nord_face_young_1, nord_face_old_2],

  ["nord_trained_footman","Honor Bounds Bane","Honor Bound Banes",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield|tf_guarantee_helmet,0,0,fac_kingdom_4,
  ...
  ["nord_warrior","Lightyears Ahead","Lightyears Ahead",tf_guarantee_boots|tf_guarantee_armor|tf_guarantee_shield|tf_guarantee_helmet,0,0,fac_kingdom_4,
